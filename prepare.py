...
for training_name in train_labels:
    ...
    for file in images:
        ...
        ###################################
        global_feature = np.hstack([fv_histogram, fv_5])
...
#pdb.set_trace()
#l = 0
#for i in rescaled_features:#

h5f_data.create_dataset(f'dataset_1', data=np.array(rescaled_features))
#    l += 1

h5f_label = h5py.File(h5_labels, 'w')
#l = 0
#for i in target:
h5f_label.create_dataset(f'dataset_1', data=np.array(target))
#    l +=1
